...
from app.dependencies.main import get_async_db, get_auth_repository, get_user_repository
...
async def get_current_user(
    bearer=Depends(http_bearer), user_repository: UserRepository = Depends(get_user_repository)
) -> UserModel:
    try:

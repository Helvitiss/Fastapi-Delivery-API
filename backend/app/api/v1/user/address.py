...
@router.post("/", status_code=201, response_model=AddressResponse, summary="Создать адрес")
...
@router.get("/", response_model=list[AddressResponse], summary="Список адресов")
...
@router.delete("/{address_id}", status_code=204, summary="Удалить адрес")

...
@pytest.fixture
def order_service(mock_session, order_repo, cart_repo, cart_item_repo):
    return OrderService(
...
async def test_create_order_success(order_service, order_repo, cart_repo, cart_item_repo):
    user_id = 1
    address_id = 10
